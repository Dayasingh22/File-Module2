            ...
            <div className="main-content-list">
              <div className="node-fields">
                {nodes.textField === "true" ? (
                  <div className="div-node">
                    <h3 style={{ marginTop: "15px" }}>Text Field</h3>
                    <button
                      onClick={() => {
              ...
              <div className="node-fields">
                {nodes.textField2 === "true" ? (
                  <div className="div-node">
                    <h3 style={{ marginTop: "15px" }}>2nd Text Field</h3>
                    <button
                      onClick={() => {
              ...
              <div className="node-fields">
                {nodes.textField3 === "true" ? (
                  <div className="div-node">
                    <h3 style={{ marginTop: "15px" }}>3rd Text Field</h3>
                    <button
                      onClick={() => {
              ...
              <div className="node-fields">
                {nodes.textArea === "true" ? (
                  <div className="div-node">
                    <h3 style={{ marginTop: "15px" }}>Text Area</h3>
                    <button
                      onClick={() => {
              ...
              <div className="node-fields">
                {nodes.textArea2 === "true" ? (
                  <div className="div-node">
                    <h3 style={{ marginTop: "15px" }}>2nd Text Area</h3>
                    <button
                      onClick={() => {
              ...
              <div className="node-fields">
                {nodes.textArea3 === "true" ? (
                  <div className="div-node">
                    <h3 style={{ marginTop: "15px" }}>3rd Text Area</h3>
                    <button
                      onClick={() => {
              ...
              <div className="node-fields">
                {nodes.Image === "true" ? (
                  <div className="div-node">
                    <h3 style={{ marginTop: "15px" }}>Image</h3>
                    <button
                      onClick={() => {
                        delete nodes.Image;
                        setNodeImage(false);
              ...
              <div className="node-fields">
                {nodes.Image2 === "true" ? (
                  <div className="div-node">
                    <h3 style={{ marginTop: "15px" }}>2nd Image</h3>
                    <button
                      onClick={() => {
                        delete nodes.Image2;
                        setNodeImage2(false);
              ...
              <div className="node-fields">
                {nodes.Image3 === "true" ? (
                  <div className="div-node">
                    <h3 style={{ marginTop: "15px" }}>3rd Image</h3>
                    <button
                      onClick={() => {
                        delete nodes.Image3;
                        setNodeImage3(false);
              ...
              <div className="node-fields">
                {nodes.code === "true" ? (
                  <div className="div-node">
                    <h3 style={{ marginTop: "15px" }}>Code Area</h3>
                    <button
                      onClick={() => {
                        delete nodes.code;
                        setCodeNode(false);
              ...
              <div className="node-fields">
                {nodes.code2 === "true" ? (
                  <div className="div-node">
                    <h3 style={{ marginTop: "15px" }}>2nd Code Area</h3>
                    <button
                      onClick={() => {
                        delete nodes.code2;
                        setCodeNode2(false);
              ...
              <div className="node-fields">
                {nodes.code3 === "true" ? (
                  <div className="div-node">
                    <h3 style={{ marginTop: "15px" }}>3rd Code Area</h3>
                    <button
                      onClick={() => {
                        delete nodes.code3;
                        setCodeNode3(false);
